...
module.exports = {
    ...
    async execute(interaction) {
        ...
        await interaction.reply(`There are ${allItemsCache.filter(i => !i.soldOut).length}/${allItemsCache.length} items that aren't out of stock in inabakumori's booth\nLast valid check: <t:${Math.floor(lastCheck / 1000)}:R>`);
    },
};